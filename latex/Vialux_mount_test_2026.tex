...
Vialux mount (see Fig.~\ref{fig:Vialux_mount_LS}), with and without foam
damping. These configurations are summarized in Table~\ref{tab:conditions}, and
configurations 2 and 5 are shown in Fig.~\ref{fig:configs}.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{images/config_2_5.pdf}
	\caption{
		\textbf{Different mounting configurations.}
		(left) Configuration 2: Custom steal mount with foam damping. (right) Configuration 5: Vialux mount with foam damping and lateral stabilizers.
	}
	\label{fig:configs}
\end{figure}
